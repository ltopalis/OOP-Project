...
public class RequestDonationList{ 
    ...
    public boolean add(RequestDonation requestDonation, Organization organization)throws ElementDoesntExist {
         // check if entity exists in organiZation's entityList 
        if (organization.checkEntityExists(requestDonation.getEntity())) {throw new ElementDoesntExist();}
